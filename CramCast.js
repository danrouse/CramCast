(function() {
	...
	var _cramcast = {
		settings: {
			...
			currency_symbols: ['$'],
			major_punct_symbols: ['.', '?'],
			context_before_length: 0, //12
			context_after_length: 0, //18
	...
	_cramcast.elems = {
		...
		panel: document.getElementById('_cramcast_panel'),
	...
	_cramcast.resize = function() {
		...
		// Set vertical offset of container
		_cramcast.elems.panel.style.marginTop = '-' + Math.floor(_cramcast.elems.panel.offsetHeight/2) + 'px';
	}
	...
	window.onresize = _cramcast.resize;
